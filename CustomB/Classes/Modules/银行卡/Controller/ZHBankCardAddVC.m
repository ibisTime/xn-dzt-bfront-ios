...
- (void)viewDidLoad {
    ...
    //
    UIButton *btn = [[UIButton alloc] initWithFrame:CGRectMake(20, self.pwdInputView.yy + 30, SCREEN_WIDTH - 40, 44) title:@"确定" backgroundColor:[UIColor colorWithHexString:@"9ba9b5"] cornerRadius:5];
