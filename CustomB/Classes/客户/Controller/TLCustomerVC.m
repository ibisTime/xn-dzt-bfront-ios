...
- (void)viewDidLoad {
    ...
    //
    self.switchScrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, smallChooseView.yy, SCREEN_WIDTH, SCREEN_HEIGHT - [DeviceUtil top64] - [DeviceUtil bottom49] - smallChooseView.bottom)];
